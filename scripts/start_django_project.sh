...
function start_django_project() {
    ...
    workon $project_name
    pip install django django-js-utils==0.0.5dev django-bootstrap-form django-pipeline South akismet cssmin pytz==2013d hamlpy PIL MySQL-python python-memcached #johnny-cache
    if [ $? -ne 0 ]; then
